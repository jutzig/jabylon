 ...
 * <ul>
 *   <li>{@link org.jabylon.users.impl.UserImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.jabylon.users.impl.UserImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link org.jabylon.users.impl.UserImpl#getRoles <em>Roles</em>}</li>
 *   <li>{@link org.jabylon.users.impl.UserImpl#getPermissions <em>Permissions</em>}</li>
