...
public class ReviewFactoryImpl extends EFactoryImpl implements ReviewFactory {
	...
	public static ReviewFactory init() {
		try {
			ReviewFactory theReviewFactory = (ReviewFactory)EPackage.Registry.INSTANCE.getEFactory("http://jutzig.de/jabylon/review"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ReviewPackage.PROPERTY_FILE_REVIEW: return (EObject)createPropertyFileReview();
			case ReviewPackage.COMMENT: return (EObject)createComment();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ReviewPackage.REVIEW_STATE:
				return createReviewStateFromString(eDataType, initialValue);
			case ReviewPackage.SEVERITY:
	 ...
	 * @generated
	 */
	public PropertyFileReview createPropertyFileReview() {
		PropertyFileReviewImpl propertyFileReview = new PropertyFileReviewImpl();
		return propertyFileReview;
	}
