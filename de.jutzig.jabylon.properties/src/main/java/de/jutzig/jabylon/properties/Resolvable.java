 ...
 * <ul>
 * <li>{@link de.jutzig.jabylon.properties.Resolvable#getPercentComplete <em>
 * Percent Complete</em>}</li>
 * <li>{@link de.jutzig.jabylon.properties.Resolvable#getChildren <em>Children
 * </em>}</li>
 * <li>{@link de.jutzig.jabylon.properties.Resolvable#getParent <em>Parent</em>}
 * </li>
...
public interface Resolvable<P extends Resolvable<?, ?>, C extends Resolvable<?, ?>> extends CDOObject {
     ...
     * {@link de.jutzig.jabylon.properties.Resolvable#getPercentComplete
     ...
     * list. The list contents are of type {@link C}. It is bidirectional and
     * its opposite is '
     * {@link de.jutzig.jabylon.properties.Resolvable#getParent <em>Parent</em>}
     * '. <!-- begin-user-doc -->
     * <p>
     ...
     * {@link de.jutzig.jabylon.properties.Resolvable#getChildren
    ...
    /**
     * Sets the value of the '
     * {@link de.jutzig.jabylon.properties.Resolvable#getName <em>Name</em>}'
